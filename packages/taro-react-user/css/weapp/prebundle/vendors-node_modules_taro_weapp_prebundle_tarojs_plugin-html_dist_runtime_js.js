...
function genAttrMapFnFromDir(dir) {
    const fn = function(key, value) {
        ...
        if (lowerKey in dir) {
            ...
            if ((0,_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.isString)(res)) {
                key = res;
            } else {
                key = res[0];
...
var specialElements = /* @__PURE__ */ new Map([
    ...
    [
        ...
        {
            mapName (props) {
                if (props.as && (0,_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.isString)(props.as)) return props.as.toLowerCase();
...
function getMappedType(nodeName, rawProps) {
    if (inlineElements.has(nodeName)) {
        ...
        if ((0,_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.isString)(mapping)) {
            return mapping;
        }
        const { mapName  } = mapping;
        return (0,_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(mapName) ? mapName(rawProps) : mapName;
    } else {
        return "view";
    }
}
...
function getMapNameByCondition(nodeName, attr, props) {
    const mapping = specialElements.get(nodeName);
    if (!mapping || (0,_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.isString)(mapping)) return;
    const { mapName , mapNameCondition  } = mapping;
    if (!mapNameCondition) return;
    if (mapNameCondition.indexOf(attr) > -1 && !(0,_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.isString)(mapName)) {
...
_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.hooks.tap("modifyHydrateData", (data)=>{
    const nodeName = data["nn"];
    if (!isHtmlTags(nodeName)) return;
    (0,_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.warn)(data["nn"] === "select", "\u8BF7\u4F7F\u7528 Picker \u7EC4\u4EF6\u4EE3\u66FF <select>");
...
_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.hooks.tap("modifySetAttrPayload", (element, key, payload, componentsAlias)=>{
    ...
    if (attrMapFn) {
        ...
        payload.path = `${_path}.${(0,_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(alias[key])}`;
    }
    if (key === "cl") {
...
_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.hooks.tap("modifyRmAttrPayload", (element, key, payload, componentsAlias)=>{
    const { nodeName , _path , props  } = element;
    if (!isHtmlTags(nodeName)) return;
    mapNameByContion(nodeName, key, element, componentsAlias);
    const mapName = getMappedType(nodeName, props);
...
_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.hooks.tap("onAddEvent", (type, _handler, _options, node)=>{
    node = node;
...
_chunk_JBC2HC5Z_js__WEBPACK_IMPORTED_MODULE_0__.hooks.tap("modifyTaroEvent", (event, element)=>{
