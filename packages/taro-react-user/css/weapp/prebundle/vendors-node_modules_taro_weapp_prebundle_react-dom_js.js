...
(0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_1__.init_runtime_esm)();
...
function getUpdatePayload(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_1__.FormElement;
    for(i in newProps){
...
var hostConfig = {
    ...
    createInstance (type) {
        return _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createElement(type);
    },
    ...
    createTextInstance (text) {
        return _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createTextNode(text);
    },
