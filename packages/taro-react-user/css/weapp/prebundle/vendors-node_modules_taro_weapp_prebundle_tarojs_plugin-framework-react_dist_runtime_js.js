...
function setRouterParams(options) {
    _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.router = Object.assign({
...
var createTaroHook = (lifecycle)=>{
    return (fn)=>{
        ...
        React.useLayoutEffect(()=>{
            let inst = instRef.current = (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.getPageInstance)(id);
            let first = false;
            if (!inst) {
                first = true;
            ...
            if (first) {
                (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.injectPageInstance)(inst, id);
            }
            return ()=>{
...
var useRouter = (dynamic = false)=>{
    ...
    return dynamic ? _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.router : React.useMemo(()=>_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.router, []);
};
...
var ReactDOM$1;
var Fragment;
var pageKeyId = (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.incrementId)();
...
function connectReactPage(R, id) {
    return (Page)=>{
        ...
        const inject = (node)=>node && (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.injectPageInstance)(node, id);
        ...
        return class PageWrapper extends R.Component {
            static getDerivedStateFromError(error) {
                var _a, _b;
                (_b = (_a = _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.app) === null || _a === void 0 ? void 0 : _a.onError) === null || _b === void 0 ? void 0 : _b.call(_a, error.message + error.stack);
                return {
                    hasError: true
                };
            }
...
function createReactApp(App, react, dom, config) {
    ...
    function renderReactRoot() {
        ...
        let appId = "app";
        if (false) {}
        const container = _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.document$1.getElementById(appId);
    ...
    function triggerAppHook(lifecycle, ...option) {
        const instance = (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.getPageInstance)(HOOKS_APP_ID);
        if (instance) {
            const app = getAppInstance();
    ...
    _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.app = appObj;
    return appObj;
}
var getNativeCompId = (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.incrementId)();
var h;
var ReactDOM;
function initNativeComponentEntry(R, ReactDOM2) {
    ...
    class Entry extends R.Component {
        componentDidMount() {
            _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.app = this;
        }
        mount(Component, compId, getCtx) {
            const isReactComponent = isClassComponent(R, Component);
            const inject = (node)=>node && (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.injectPageInstance)(node, compId);
            const refs = isReactComponent ? {
                ref: inject
            } : {
                forwardedRef: inject,
        ...
        unmount(compId) {
            ...
            this.setState({
                ...
                (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.removePageInstance)(compId);
            });
        }
        render() {
            const components = this.state.components;
    ...
    const app = _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.document$1.getElementById("app");
...
function createNativeComponentConfig(Component, react, reactdom, componentConfig) {
    ...
    const componentObj = {
        ...
        created () {
            if (!_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.app) {
        ...
        attached () {
            ...
            _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.app.mount(Component, compId, ()=>this);
        },
        ready () {
            (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onReady");
        },
        detached () {
            resetCurrent();
            _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.app.unmount(this.compId);
        },
        pageLifetimes: {
            show (options) {
                (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onShow", options);
            },
            hide () {
                (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onHide");
            }
        },
        methods: {
            eh: _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.eventHandler,
            onLoad (options) {
                (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onLoad", options);
            },
            onUnload () {
                (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onUnload");
            }
        }
    };
    function resetCurrent() {
        _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.page = null;
        _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.router = null;
    }
    function setCurrent(compId) {
        const pages = getCurrentPages();
        const currentPage = pages[pages.length - 1];
        if (_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.page === currentPage) return;
        _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.page = currentPage;
        const route = currentPage.route || currentPage.__route__;
        const router = {
            params: currentPage.options || {},
            path: (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.addLeadingSlash)(route),
            $taroPath: compId,
            onReady: "",
            onHide: "",
            onShow: ""
        };
        _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.Current.router = router;
    ...
    if (Component.onShareAppMessage || ((_a = Component.prototype) === null || _a === void 0 ? void 0 : _a.onShareAppMessage) || Component.enableShareAppMessage) {
        componentObj.methods.onShareAppMessage = function(options) {
            ...
            if (target) {
                const id = target.id;
                const element = _chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.document$1.getElementById(id);
                if (element) {
                    target.dataset = element.dataset;
                }
            }
            return (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onShareAppMessage", options);
        };
    }
    if (Component.onShareTimeline || ((_b = Component.prototype) === null || _b === void 0 ? void 0 : _b.onShareTimeline) || Component.enableShareTimeline) {
        componentObj.methods.onShareTimeline = function() {
            return (0,_chunk_6FUDFIS6_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onShareTimeline");
        };
    }
    return componentObj;
}
